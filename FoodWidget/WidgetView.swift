...
//    var nutrient: MacroData {
//        MacroData(amount: entry.mealPlan?.getTotalNutrients(entry.nutrient.nutrientID) ?? 0, goal: entry.mealPlan?.nutrientGoals[entry.nutrient.nutrientID] ?? 0)
//    }
