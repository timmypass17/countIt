...
//    // Function to calculate grams from percentages and calories
//    func calculateGrams(for calories: Int) -> (carbs: Int, protein: Int, fats: Int) {
//        let totalCalories = Double(calories)
//        
//        // If grams are provided, use them
//        if let customCarbs = carbsGrams, let customProtein = proteinGrams, let customFats = fatsGrams {
//            return (customCarbs, customProtein, customFats)
//        }
//        
//        // Otherwise, calculate grams from percentages
//        let carbsCals = totalCalories * Double(carbsPercentage) / 100
//        let proteinCals = totalCalories * Double(proteinPercentage) / 100
//        let fatCals = totalCalories * Double(fatsPercentage) / 100
//        
//        return (
//            Int(round(carbsCals / 4)),  // 1g carbs = 4 kcal
//            Int(round(proteinCals / 4)), // 1g protein = 4 kcal
//            Int(round(fatCals / 9))      // 1g fat = 9 kcal
//        )
//    }
}
