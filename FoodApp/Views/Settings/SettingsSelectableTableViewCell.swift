//
//  SettingsSelectableTableViewCell.swift
//  FoodApp
//
...
class SettingsSelectableTableViewCell: SettingsTableViewCell {
    
    static let reuseIdentifier = "SettingsSelectableTableViewCell"
    ...
    override func update(with model: SettingsViewController.Model) {
        super.update(with: model)
        secondaryLabel.text = model.secondary?.lowercased()
